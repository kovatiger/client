...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../CSS/userPassTest.css"/>
...
<div class="main">
    <form>
        <div class="form-title">
            Чтобы пройти тестирование ответьте на каждый представленный вопрос
        </div>
    </form>
    <button class="send">Завершить тест</button>
</div>
<footer>
    <div class="contacts">
...
<script src="../../userPassTest.js"></script>
</body>
</html>
