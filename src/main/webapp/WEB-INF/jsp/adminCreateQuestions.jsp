    ...
    <div class="main2">
      <div class="window">
        ...
        <form>
          ...
          <div class="question">
            <label class="flex">
              <input class="answer1" type="text" placeholder="Ответ 1" />
            </label>
            <label class="flex">
              <input class="answer2" type="text" placeholder="Ответ 2" />
            </label>
            <label class="flex"
              ><input class="answer3" type="text" placeholder="Ответ 3" />
            </label>
            <label class="flex">
              <input class="answer4" type="text" placeholder="Ответ 4" />
            </label>
            <div>Выберите, какой из ответов верный</div>
            <label>
              <input class="rad cor1" checked name="razdel" type="radio" />
              1</label
            >
            <label>
              <input class="rad cor2" name="razdel" type="radio" /> 2</label
            >
            <label>
              <input class="rad cor3" name="razdel" type="radio" /> 3</label
            >
            <label>
              <input class="rad cor4" name="razdel" type="radio" /> 4</label
            >
          </div>
          <div class="answer">
